...
const getBranchType = (branch = "", code = "") => {
  ...
  if (b.includes("CSE") || b.includes("CSM") || b.includes("CSD") || b.includes("CSC") || b.includes("CSB") || b.includes("CSO") || b.includes("CSI") || b.includes("CIC") || b.includes("AIM") || b.includes("AID") || b.includes("AI") || b.includes("DATA") || b.includes("CYBER") || b.includes("COMPUTER") || b.includes("INFORMATION") || /\bIT\b/.test(b) || b.includes("IOT") || b.includes("ARTIFICIAL") || b.includes("MACHINE LEARNING")) return "computing";
